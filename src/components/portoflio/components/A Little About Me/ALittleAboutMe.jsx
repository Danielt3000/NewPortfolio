...
function ALittleAboutMe() {
  return (
    <div className="bg-color text-white p-5 text-center m-auto xL:w-9/12 xl:w-7/12">
      <div>
        <div>
        ...
        <div className="sm:flex sm:justify-around ">
          <div className=" text-left  md:w-10/12  mt-10  md:mt-14 ">
            ...
            <p className="text-sm leading-6 md:text-base  ">
              I'm a passionate web developer experienced in JavaScript, Django,
              HTML, CSS, and React. Specializing in creating dynamic and
              interactive user experiences, I excel in both front-end and
